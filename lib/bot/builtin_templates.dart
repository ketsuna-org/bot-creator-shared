...
final welcomeTemplate = BotTemplate(
  id: 'welcome',
  name: 'template_welcome_name',
  description: 'template_welcome_description',
...
final moderationTemplate = BotTemplate(
  id: 'moderation',
  name: 'template_moderation_name',
  description: 'template_moderation_description',
...
final utilityTemplate = BotTemplate(
  id: 'utility',
  name: 'template_utility_name',
  description: 'template_utility_description',
...
final funTemplate = BotTemplate(
  id: 'fun',
  name: 'template_fun_name',
  description: 'template_fun_description',
